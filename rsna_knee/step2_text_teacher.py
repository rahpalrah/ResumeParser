...
if not _r:
    ...
    raise FileNotFoundError(
        "Run step 1 (notebook A), Save Version, then here: Add Data -> Your "
        "Work -> Notebook Output -> that notebook. The competition data and any "
        "preprocessed-image dataset are not substitutes for it.")
print("rule features from:", _r[0])
